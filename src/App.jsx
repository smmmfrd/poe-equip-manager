...
export default function App() {
	...
	const bugReportDialog = useRef(null);
	...
	return (
		<>
			<BugReport ref={bugReportDialog} close={() => bugReportDialog.current.close()} />
			<header className="bg-neutral-content text-neutral px-4 py-1 flex justify-between items-center">
				...
				<nav className="flex flex-row-reverse gap-2">
					...
					<button className="btn btn-square btn-ghost"
						onClick={() => bugReportDialog.current.showModal()}
						title="Report a Bug">
